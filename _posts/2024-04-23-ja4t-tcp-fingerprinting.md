...
![Comparison of JA4T, JA4TS, and JA4TScan](/assets/img/2024-04-23/ja4tcptable.webp){: .mx-auto }
...
![Attempting to use a page from the children's book, “Go Dog. Go!” to explain TCP.](/assets/img/2024-04-23/tcp.gif){: .mx-auto }
...
![A TCP SYN packet and the parts that we are looking at.](/assets/img/2024-04-23/tcpsyn.webp){: .mx-auto }
...
![Common TCP Options Used](/assets/img/2024-04-23/tcpoptions.webp){: .mx-auto }
...
![MSS](/assets/img/2024-04-23/mss.webp){: .mx-auto }
...
![p0f](/assets/img/2024-04-23/p0f.webp){: .mx-auto }
<figcaption class="text-center">p0f</figcaption>

![hershel+](/assets/img/2024-04-23/hershel+.webp){: .mx-auto }
<figcaption class="text-center">hershel+</figcaption>

![Nmap](/assets/img/2024-04-23/nmap.webp){: .mx-auto }
...
![JA4T Gif](/assets/img/2024-04-23/ja4tgif.gif){: .mx-auto }

![JA4T Examples](/assets/img/2024-04-23/examples.webp){: .mx-auto }
...
![Mobile Carrier MSSs](/assets/img/2024-04-23/mobilecarriers.webp){: .mx-auto }

Which means we can identify the carrier that devices are on:

![Mobile Carrier JA4Ts](/assets/img/2024-04-23/mobilecarriersja4ts.webp){: .mx-auto }
...
![VPN JA4Ts](/assets/img/2024-04-23/vpnja4ts.webp){: .mx-auto }
...
![Client dependency of JA4TS](/assets/img/2024-04-23/clientdependentja4ts.webp){: .mx-auto }

## JA4TScan: Active TCP Server Fingerprinting

![JA4TScan](/assets/img/2024-04-23/ja4tscan.webp){: .mx-auto }
...
![JA4TScan as seen in Wireshark](/assets/img/2024-04-23/wiresharkja4tscan.webp){: .mx-auto }
...
![Example JA4TScan fingerprints](/assets/img/2024-04-23/exampleja4tscans.webp){: .mx-auto }
...
![Top JA4T fingerprints according to GreyNoise](/assets/img/2024-04-23/greynoise.webp){: .mx-auto }
...
![Scanning priorities](/assets/img/2024-04-23/scanningpriorities.webp){: .mx-auto }
...
![JA4H and JA4T fingerprints](/assets/img/2024-04-23/ja4hja4t.webp){: .mx-auto }
...
![JA4 and JA4T fingerprints](/assets/img/2024-04-23/ja4ja4t.webp){: .mx-auto }
